    ...
    class PacientesC{
            ...
            echo'
                <tr>
                    ...
                    if($resultado["foto"] == null){
                        ...
                        echo'
                            <td><img src="'.$resultado["foto"].'" width="40px"></td>
                        ';
                    }
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xs-12">
                            ...
                            if($resultado["foto"]!=""){
                                echo'
                                    <img src="http://localhost/clinica/'.$resultado["foto"].'" width="200px" class="img-responsive">
                                ';
                            }else{
                                echo'
                                    <img src="http://localhost/clinica/Vistas/img/defecto.png" width="200px" class="img-responsive">
                                ';
                            }
                        ...
                        echo'
                            ...
                            <button type="submit" class="btn btn-success">Gurdar Cambios</button>
        ...
        public function ActualizarPerfilPacienteC(){
            if(isset($_POST["Pid"])){
                ...
                $tablaBD="pacientes";
                $datosC = array("id"=>$_POST["Pid"], "nombre"=>$_POST["nombrePerfil"], "apellido"=>$_POST["apellidoPerfil"], "usuario"=>$_POST["usuarioPerfil"], 
                    "clave"=>$_POST["clavePerfil"], "documento"=>$_POST["documentoPerfil"], "foto"=>$rutaImg);
