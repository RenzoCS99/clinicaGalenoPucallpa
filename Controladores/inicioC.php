    ...
    class InicioC{
        ...
        public function ActualizarInicioC(){
            if(isset($_POST["Iid"])){
                ...
                $tablaBD = "inicio";
                $datosC = array("id"=>$_POST["Iid"], "intro"=>$_POST["intro"], "horaE"=>$_POST["horaE"],"horaS"=>$_POST["horaS"], "telefono"=>$_POST["telefono"], 
                "correo"=>$_POST["correo"], "direccion"=>$_POST["direccion"], "logo"=>$rutalogo, "favicon"=>$rutaFavicon);
