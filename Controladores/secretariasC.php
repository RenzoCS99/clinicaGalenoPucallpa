...
class SecretariasC{
    ...
    public function  ActualizarPerfilSecretariaC(){
        if (isset($_POST["idP"])){
            ...
            $tablaBD = "secretarias";
            $datosC = array("id"=>$_POST["idP"], "usuario"=>$_POST["usuarioP"], "apellido"=>$_POST["apellidoP"], "nombre"=>$_POST["nombreP"], 
                            "clave"=>$_POST["claveP"], "foto"=>$rutaImg);
